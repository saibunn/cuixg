...
// 文件上传接口
export const uploadFile = "/pgyhr/upload/file"
// 验证码渲染图片接口
export const drawCodeImage = "/pgyhr/common/captcha/draw/"
// 获取菜单
export const getMenuList = "/pgyhr/permission/getMenuList"
// 获取数据字典
export const getDictData = "/pgyhr/dictData/getByType/"
