...
import iconChoose from "@/views/my-components/pgyhr/icon-choose";
import countDownButton from "@/views/my-components/pgyhr/count-down-button";
import departmentChoose from "@/views/my-components/pgyhr/department-choose";
import departmentTreeChoose from "@/views/my-components/pgyhr/department-tree-choose";
import userChoose from "@/views/my-components/pgyhr/user-choose";
import uploadPicInput from "@/views/my-components/pgyhr/upload-pic-input";
import uploadPicThumb from "@/views/my-components/pgyhr/upload-pic-thumb";
import checkPassword from "@/views/my-components/pgyhr/check-password";
import setPassword from "@/views/my-components/pgyhr/set-password";
export default {
  name: "pgyhr-components",
  components: {
    TreeTable,
    iconChoose,
    countDownButton,
