package com.pgyhr.generator;

import com.pgyhr.core.common.exception.PgyhrException;
import com.pgyhr.generator.bean.Entity;
import com.pgyhr.generator.bean.Item;
...
/**
 * @author cuixg
 * @title: PgyhrGenerator
 * @projectName pgyhr-module
 * @description: 代码生成器
 * @date 2020/4/3  11:33
 */
@Slf4j
public class PgyhrGenerator {
     ...
     * (文件自动生成至该包下)
     */
    private static final String daoPackage = "com.pgyhr.your.dao";
    ...
    public static void main(String[] args) throws IOException {
        ...
        // 模板路径
        String root = System.getProperty("user.dir")+"/pgyhr-modules/pgyhr-generator/src/main/java/com/pgyhr/generator/template";
    ...
    public static String name(String name, boolean isFirstUpper){
        ...
        if(StrUtil.isBlank(name)){
            throw new PgyhrException("name不能为空");
        }
