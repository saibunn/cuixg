 ...
 */
@Data
public class EmpBackTaskSheetSearchRequestDTO extends CommonListDTO implements Serializable {


    private static final long serialVersionUID = -8746919428785371726L;
    /**
     * 雇员后道任务单ID
     */
