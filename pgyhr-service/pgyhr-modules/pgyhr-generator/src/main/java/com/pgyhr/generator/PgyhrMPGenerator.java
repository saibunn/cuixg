...
import static com.pgyhr.generator.PgyhrGenerator.*;
import static com.pgyhr.generator.PgyhrGenerator.name;

/**
 * @author cuixg
 * @title: PgyhrMPGenerator
 * @projectName pgyhr-module
 * @description: 代码生成器 Mybatis-Plus
 * @date 2020/4/3  11:33
 */
@Slf4j
public class PgyhrMPGenerator {
