package com.pgyhr.open.controller;

import com.pgyhr.core.base.PgyhrBaseController;
...
import com.pgyhr.open.service.ClientService;
...
@RequestMapping("/pgyhr/client")
@Transactional
public class ClientController extends PgyhrBaseController<Client, String> {
