...
import com.pgyhr.core.common.exception.LimitException;
import com.pgyhr.core.common.limit.RedisRaterLimiter;
import com.pgyhr.core.common.utils.IpInfoUtil;
import com.pgyhr.core.config.properties.PgyhrIpLimitProperties;
import com.pgyhr.core.config.properties.PgyhrLimitProperties;
...
public class LimitRaterInterceptor extends HandlerInterceptorAdapter {
    ...
    @Autowired
    private PgyhrLimitProperties limitProperties;

    @Autowired
    private PgyhrIpLimitProperties ipLimitProperties;
